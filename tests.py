...
class ActionClassTest(unittest.TestCase):
    ...
    def test_action_creation(self):
        ...
        action.add_precondition(representations.Predicate.parse_grounded('(block ?x0)'))
        action.add_precondition(representations.Predicate.parse_grounded('(free ?x0)'))
        action.add_positive_effect(representations.Predicate.parse_grounded('(holding ?x0)'))
        action.add_negative_effect(representations.Predicate.parse_grounded('(free ?x0)'))
        # print str(action)
...
class DomainClassTest(unittest.TestCase):
    ...
    def test_domain_creation(self):
        ...
        action.add_precondition(representations.Predicate.parse_grounded('(block ?x0)'))
        action.add_precondition(representations.Predicate.parse_grounded('(free ?x0)'))
        action.add_precondition(representations.Predicate.parse_grounded('(free ?x1)'))
        action.add_precondition(representations.Predicate.parse_grounded('(on ?x0 ?x1)'))
        action.add_positive_effect(representations.Predicate.parse_grounded('(on ?x0 ?x2)'))
        action.add_positive_effect(representations.Predicate.parse_grounded('(free ?x1)'))
        action.add_negative_effect(representations.Predicate.parse_grounded('(on ?x0 ?x1)'))
        action.add_negative_effect(representations.Predicate.parse_grounded('(free ?x2)'))
